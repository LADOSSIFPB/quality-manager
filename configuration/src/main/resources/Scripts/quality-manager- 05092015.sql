...
(1, '10783898000175', 'Instituto Federal de Educação, Ciência e Tecnologia da Paraíba', 'IFPB', 1, '2014-12-26 20:38:26'),
(2, '03508097000136', 'Rede Nacional de Pesquisa', 'RNP', 1, '2015-02-16 20:14:51'),
(3, '00889834000108', 'Coordenação de Aperfeiçoamento de Pessoal de Nível Superior', 'Capes', 1, '2015-03-05 02:29:37'),
(4, '33654831000136', 'Conselho Nacional de Desenvolvimento Científico e Tecnológico', 'CNPQ', 1, '2015-03-05 02:31:35'),
(5, '43828151000145', 'Fundação de Amparo à Pesquisa do Estado de São Paulo', 'FAPESP', 1, '2015-03-06 20:42:50'),
(6, '23483924738247', 'Universidade Federal de Campina Grande', 'UFCG', 1, '2015-03-21 06:20:54'),
(7, '24566440000179', 'Fundação de Amparo à Ciência e Tecnologia de Pernambuco', 'FACEPE', 1, '2015-03-27 19:03:14');
...
CREATE TABLE IF NOT EXISTS `tb_pessoa` (
  ...
  `campus_institucional_id` int(11) NOT NULL,
  `dt_registro` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  KEY `fk_pessoa_local` (`campus_institucional_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;
...
INSERT INTO `tb_pessoa` (`id_pessoa`, `nm_pessoa`, `nr_cpf`, `nr_matricula`, `nm_endereco`, `nm_cep`, `nm_telefone`, `nm_email`, `nm_url_lattes`, `nm_senha`, `tipo_pessoa_id`, `campus_institucional_id`, `dt_registro`) VALUES
...
(165, 'José da Silva', 101010, 3, 19, 3, 3, 'jsilva@gmail.com', 1);
...
CREATE TABLE IF NOT EXISTS `tb_projeto` (
  ...
  KEY `fk_projeto_local` (`campus_institucional_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
ALTER TABLE `tb_pessoa`
  ADD CONSTRAINT `fk_pessoa_local` FOREIGN KEY (`campus_institucional_id`) REFERENCES `tb_campus_institucional` (`id_campus_institucional`),
...
ALTER TABLE `tb_projeto`
  ...
  ADD CONSTRAINT `fk_projeto_local` FOREIGN KEY (`campus_institucional_id`) REFERENCES `tb_campus_institucional` (`id_campus_institucional`);
...
--
ALTER TABLE `tb_projeto` 
  ADD `area_id` INT NOT NULL AFTER `campus_institucional_id` ,
  ADD INDEX ( `area_id` ) ;
...
--
ALTER TABLE `tb_projeto` 
  ADD `grande_area_id` INT NOT NULL AFTER `campus_institucional_id` ,
...
INSERT INTO `qmanager`.`tb_role` (`id_role`, `nm_role`, `dt_registro`) VALUES (NULL, 'gestor', CURRENT_TIMESTAMP), (NULL, 'servidor', CURRENT_TIMESTAMP);
INSERT INTO `qmanager`.`tb_role` (`id_role`, `nm_role`, `dt_registro`) VALUES (NULL, 'aluno', CURRENT_TIMESTAMP), (NULL, 'visitante', CURRENT_TIMESTAMP);
...
INSERT INTO `qmanager`.`tb_pessoa_role` (`pessoa_id`, `role_id`) VALUES ('1', '1'), ('2', '3');
INSERT INTO `qmanager`.`tb_pessoa_role` (`pessoa_id`, `role_id`) VALUES ('3', '2'), ('4', '3');
...
CREATE TABLE IF NOT EXISTS `tb_edital_campus_submissao` (
  `id_edital_campus_submissao` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador da tabela',
  `edital_id` int(11) NOT NULL COMMENT 'Chave do Edital',
  `campus_institucional_id` int(11) NOT NULL COMMENT 'Chave do Campus',
  `dt_registro` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_edital_campus_submissao`),
...
ALTER TABLE `tb_projeto` ADD `nm_palavras_chave` VARCHAR(255) NOT NULL ;
